package com.example.Isaac.controller;

import com.example.Isaac.model.File;
import com.example.Isaac.Repository.FileRepository;
...
public class FileController {
    ...
    @PostMapping("/web")
    public String webUpload(@RequestParam("file") MultipartFile uploadedFile) throws IOException {
        upload(uploadedFile);
        return webView();
    }
}